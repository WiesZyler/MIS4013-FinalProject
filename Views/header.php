...
[data-bs-theme=light] {
  ...
  --bs-info-bg-subtle: #d1ecfd;
  --bs-warning-bg-subtle: #fff3cd;
  --bs-danger-bg-subtle: #fadbdd;
  --bs-light-bg-subtle: #fcfcfd;
  --bs-dark-bg-subtle: #ced4da;
  --bs-primary-border-subtle: #c5b3e6;
  --bs-secondary-border-subtle: #f7b0e3;
  --bs-success-border-subtle: #b1facd;
  --bs-info-border-subtle: #a4dafb;
  --bs-warning-border-subtle: #ffe69c;
  --bs-danger-border-subtle: #f4b7bb;
...
[data-bs-theme=dark] {
  ...
  --bs-tertiary-bg: #261e35;
  --bs-tertiary-bg-rgb: 38, 30, 53;
  --bs-primary-text-emphasis: #a98eda;
  --bs-secondary-text-emphasis: #f288d4;
  --bs-success-text-emphasis: #8af7b3;
  --bs-info-text-emphasis: #76c7fa;
  --bs-warning-text-emphasis: #ffda6a;
  --bs-danger-text-emphasis: #ef9499;
  --bs-light-text-emphasis: #f8f9fa;
  --bs-dark-text-emphasis: #dee2e6;
  --bs-primary-bg-subtle: #160d27;
  --bs-secondary-bg-subtle: #2f0b25;
  --bs-success-bg-subtle: #0c301a;
  --bs-info-bg-subtle: #052031;
  --bs-warning-bg-subtle: #332701;
  --bs-danger-bg-subtle: #2e0f11;
  --bs-light-bg-subtle: #343a40;
  --bs-dark-bg-subtle: #1a1d20;
  --bs-primary-border-subtle: #432874;
  --bs-secondary-border-subtle: #8c226e;
  --bs-success-border-subtle: #24914d;
  --bs-info-border-subtle: #106194;
  --bs-warning-border-subtle: #997404;
  --bs-danger-border-subtle: #892e33;
  ...
  --bs-link-hover-color-rgb: 186, 165, 225;
  --bs-code-color: #f288d4;
  --bs-highlight-color: #dee2e6;
  --bs-highlight-bg: #664d03;
  --bs-border-color: #495057;
  --bs-border-color-translucent: rgba(255, 255, 255, 0.15);
  --bs-form-valid-color: #8af7b3;
  --bs-form-valid-border-color: #8af7b3;
  --bs-form-invalid-color: #ef9499;
  --bs-form-invalid-border-color: #ef9499;
}
...
.form-switch .form-check-input:focus {
  --bs-form-switch-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23f59cdc'/%3e%3c/svg%3e");
}
...
.was-validated .form-control:valid, .form-control.is-valid {
  ...
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%233cf281' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
  background-repeat: no-repeat;
...
.was-validated .form-select:valid:not([multiple]):not([size]), .was-validated .form-select:valid:not([multiple])[size="1"], .form-select.is-valid:not([multiple]):not([size]), .form-select.is-valid:not([multiple])[size="1"] {
  --bs-form-select-bg-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%233cf281' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
...
.btn-secondary {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #c7309c;
  --bs-btn-hover-border-color: #bb2e93;
  --bs-btn-focus-shadow-rgb: 237, 87, 195;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #bb2e93;
  --bs-btn-active-border-color: #b02b8a;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-success {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #33ce6e;
  --bs-btn-hover-border-color: #30c267;
  --bs-btn-focus-shadow-rgb: 89, 244, 148;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #30c267;
  --bs-btn-active-border-color: #2db661;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-info {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #178ad1;
  --bs-btn-hover-border-color: #1682c5;
  --bs-btn-focus-shadow-rgb: 61, 176, 247;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #1682c5;
  --bs-btn-active-border-color: #147ab9;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-danger {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #c24148;
  --bs-btn-hover-border-color: #b63d44;
  --bs-btn-focus-shadow-rgb: 232, 103, 111;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #b63d44;
  --bs-btn-active-border-color: #ab3940;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-light {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #3ab8c5;
  --bs-btn-hover-border-color: #36aeba;
  --bs-btn-focus-shadow-rgb: 96, 223, 235;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #36aeba;
  --bs-btn-active-border-color: #33a3ae;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-dark {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #3a2849;
  --bs-btn-hover-border-color: #2e1b3e;
  --bs-btn-focus-shadow-rgb: 58, 40, 73;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #453554;
  --bs-btn-active-border-color: #2e1b3e;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.accordion {
  ...
  --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%2332fbe2'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-icon-width: 1.25rem;
  --bs-accordion-btn-icon-transform: rotate(-180deg);
  --bs-accordion-btn-icon-transition: transform 0.2s ease-in-out;
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%232c1a4d'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-focus-border-color: #f59cdc;
...
[data-bs-theme=dark] .accordion-button::after {
  --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23a98eda'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23a98eda'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
}
...
.list-group {
  ...
  --bs-list-group-disabled-bg: #250d49;
...
.link-secondary:hover, .link-secondary:focus {
  ...
  -webkit-text-decoration-color: RGBA(187, 46, 147, var(--bs-link-underline-opacity, 1)) !important;
...
.link-success:hover, .link-success:focus {
  ...
  -webkit-text-decoration-color: RGBA(48, 194, 103, var(--bs-link-underline-opacity, 1)) !important;
...
.link-info:hover, .link-info:focus {
  ...
  -webkit-text-decoration-color: RGBA(22, 130, 197, var(--bs-link-underline-opacity, 1)) !important;
...
.link-danger:hover, .link-danger:focus {
  ...
  -webkit-text-decoration-color: RGBA(182, 61, 68, var(--bs-link-underline-opacity, 1)) !important;
...
.link-light:hover, .link-light:focus {
  ...
  -webkit-text-decoration-color: RGBA(54, 174, 186, var(--bs-link-underline-opacity, 1)) !important;
...
.link-dark:hover, .link-dark:focus {
  ...
  -webkit-text-decoration-color: RGBA(18, 2, 33, var(--bs-link-underline-opacity, 1)) !important;
