...
<html lang="en" >
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#" style="color:white; text-shadow: 2px 2px 2px rgba(50, 251, 226, 0.8);">Navbar</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link" href="pack.php" style="color:white; text-shadow: 2px 2px 2px rgba(50, 251, 226, 0.8);">Packs</a>
        </li>
          <li class="nav-item">
          <a class="nav-link" href="deck.php" style="color:white; text-shadow: 2px 2px 2px rgba(50, 251, 226, 0.8);">Decks</a>
        </li>
        <li class="nav-item">
